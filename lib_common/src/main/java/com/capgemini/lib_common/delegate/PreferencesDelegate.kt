...
class PreferenceDelegate<T>(private val prefName: String = "Smart") : ReadWriteProperty<Any?, T> {

    private val prefs by lazy {
        ApplicationGlobalContext.getSharedPreferences(prefName, Context.MODE_PRIVATE)
    }
